...
if __name__ == "__main__":
    print(
        getAmzFeatures(
            "https://www.amazon.in/Apple-iPhone-13-128GB-Pink/dp/B09G9FPGTN/ref=sr_1_3?crid=17TCB2EF5AJLU&keywords=iphone+13&qid=1642432247&sprefix=iph%2Caps%2C276&sr=8-3"
        )
    )
    print(
        getFpkFeatures(
